...
{
    public class SearchUsersQueryHandler(ICacheService cacheService,
        IUserRepository userRepository) : IRequestHandler<SearchUsersQuery, PaginatedResult<UserDto>>
    {
