...
{
    public class ResolveIncidentCommandHandler : IRequestHandler<ResolveIncidentCommand, Result<Guid>>
    {
        ...
        public ResolveIncidentCommandHandler(IIncidentRepository incidentRepository, ICurrentUserService currentUserService, ICacheService cacheService, IResponderRepository responderRepository, IUnitOfWork unitOfWork)
        {
        ...
        public async Task<Result<Guid>> Handle(ResolveIncidentCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                return Result<Guid>.Success(incident.Id, "Incident resolved.");
            }
            catch (Exception ex)
            {
