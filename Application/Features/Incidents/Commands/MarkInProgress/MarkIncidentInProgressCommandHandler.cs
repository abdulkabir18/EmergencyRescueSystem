...
{
    public class MarkIncidentInProgressCommandHandler : IRequestHandler<MarkIncidentInProgressCommand, Result<Guid>>
    {
        ...
        public MarkIncidentInProgressCommandHandler(IIncidentRepository incidentRepository, ICurrentUserService currentUserService, IResponderRepository responderRepository, ICacheService cacheService, IUnitOfWork unitOfWork)
        {
        ...
        public async Task<Result<Guid>> Handle(MarkIncidentInProgressCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                return Result<Guid>.Success(incident.Id, "Incident marked as in-progress.");
            }
            catch (Exception ex)
            {
